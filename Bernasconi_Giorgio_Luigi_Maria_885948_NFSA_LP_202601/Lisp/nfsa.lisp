...
;;; proper-list-p
;;; Verifica che X sia una lista propria 
;;;(no dotted pair, no liste cicliche).
...
;;;evita warning in compilazione dato che le funzioni
;;; si chiamano a vicenda
...
;;;Verifica che FA abbia la struttura di un NFSA creato da 
;;;nfsa-compile-regex.
(defun nfsa-ok-p (fa)
  (and (nfsa-p fa)
